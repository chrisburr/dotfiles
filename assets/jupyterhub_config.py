...
# c.JupyterHub.data_files_path = '/home/cburr/miniconda/envs/jupyter/share/jupyter/hub'
...
# attempt login.
c.Authenticator.whitelist = ['cburr']
...
# c.LocalAuthenticator.group_whitelist = ['cburr']
